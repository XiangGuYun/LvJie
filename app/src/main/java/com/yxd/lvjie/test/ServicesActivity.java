...
public class ServicesActivity extends MyBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvServiceCount.setText("SERVICES:" + list.size());
        ...
        lvServices.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent1 = new Intent(ServicesActivity.this, CharacteristicsActivity.class);
            if (service.getUuid().toString().equals(GattAttributes.USR_SERVICE)) {
                intent1.putExtra("is_usr_service", true);

...
//                else if (state == BluetoothDevice.BOND_NONE) {}
    ...
    private void setOption(Option option) {
        ...
        switch (option.getPropertyType()) {
            case PROPERTY_NOTIFY:
                ToastUtils.toast("PROPERTY_NOTIFY");
                if (!nofityEnable)
                ...
                break;
            case PROPERTY_READ:
                ToastUtils.toast("PROPERTY_READ");
                btnOption.setText(Option.READ);
                showViewIsEdit(false);
                break;
            case PROPERTY_INDICATE:
                ToastUtils.toast("PROPERTY_INDICATE");
                if (!indicateEnable)
                ...
                break;
            case PROPERTY_WRITE:
                ToastUtils.toast("PROPERTY_WRITE");
                showViewIsEdit(true);
                break;
        }
    }
    ...
    private void doClick() {
        btnOptions.setOnClickListener(v ->
                optionsMenuManager.toggleContextMenuFromView(options, btnOptions, position -> {
                    dismissMenu();

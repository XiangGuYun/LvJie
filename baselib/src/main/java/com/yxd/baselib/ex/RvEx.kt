 ...
 */
interface RvEx : StringEx, ViewEx {
    ...
    /**
     * 设置列表项点击事件，可限制连续点击的频率
     * @receiver Holder
     * @param limitSecond Int
     * @param click Function1<[@kotlin.ParameterName] View, Unit>
     * @return Holder
     */
    fun Holder.itemClick(limitSecond: Int = 0, click: (view: View) -> Unit): Holder {
        getItemView().click(limitSecond) {
            click.invoke(it)
        }
        return this
    }

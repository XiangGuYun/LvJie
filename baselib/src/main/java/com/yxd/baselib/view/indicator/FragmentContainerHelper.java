...
public class FragmentContainerHelper {
    ...
    public FragmentContainerHelper(YxdIndicator YxdIndicator) {
        mYxdIndicators.add(YxdIndicator);
    }
    ...
    public void attachYxdIndicator(YxdIndicator YxdIndicator) {
        mYxdIndicators.add(YxdIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (YxdIndicator YxdIndicator : mYxdIndicators) {
            YxdIndicator.onPageSelected(pageIndex);
        }
    }

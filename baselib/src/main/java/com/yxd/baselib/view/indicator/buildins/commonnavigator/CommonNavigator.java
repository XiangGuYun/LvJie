package com.yxd.baselib.view.indicator.buildins.commonnavigator;
...
import com.yxd.baselib.view.indicator.NavigatorHelper;
import com.yxd.baselib.view.indicator.ScrollState;
...
import com.yxd.baselib.view.indicator.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
...
import com.yxd.baselib.view.indicator.buildins.commonnavigator.model.PositionData;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public void setAdapter(CommonNavigatorAdapter adapter) {
        ...
        if (mAdapter != null) {
            ...
            if (mTitleContainer != null) {  // adapter改变时，应该重新init，但是第一次设置adapter不用，onAttachToYxdIndicator中有init
                mAdapter.notifyDataSetChanged();
            }
        } else {
    ...
    @Override
    public void onAttachToYxdIndicator() {
        init(); // 将初始化延迟到这里
    }

    @Override
    public void onDetachFromYxdIndicator() {
    }

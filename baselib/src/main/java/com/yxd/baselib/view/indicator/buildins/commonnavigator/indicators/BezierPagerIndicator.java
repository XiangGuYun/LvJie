package com.yxd.baselib.view.indicator.buildins.commonnavigator.indicators;
...
import com.yxd.baselib.view.indicator.FragmentContainerHelper;
import com.yxd.baselib.view.indicator.buildins.ArgbEvaluatorHolder;
import com.yxd.baselib.view.indicator.buildins.UIUtil;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    private void init(Context context) {
        ...
        mMaxCircleRadius = DensityUtils.dp2px( 3.5);
        mMinCircleRadius = DensityUtils.dp2px( 2);
        mYOffset = DensityUtils.dp2px( 1.5);
    }

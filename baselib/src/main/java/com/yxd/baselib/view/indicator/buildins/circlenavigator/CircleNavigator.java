package com.yxd.baselib.view.indicator.buildins.circlenavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void init(Context context) {
        ...
        mRadius = DensityUtils.dp2px( 3);
        mCircleSpacing = DensityUtils.dp2px( 8);
        mStrokeWidth = DensityUtils.dp2px( 1);
    }
